...
def get_data(filters) -> list[dict]:
	...
	for surgery in bookings:
		...
		row = {
			...
			"patient_name": f'<strong><a href="/app/costing/{quote(surgery.get("patient"), safe="")}" style="color: inherit;">{surgery.get("first_name")}</a></strong>',
